                ...
                statuses = statusesByCharacterId[character.id]
                    ...
                    .map { status ->
                        RoundStatusTransfer(
                            ...
                            tickTiming = status.tickTiming.name,
    ...
    return characters.map { transferCharacter ->
        ...
        val statuses = transferCharacter.statuses.map { transferStatus ->
            Status(
                ...
                tickTiming = safeStatusTickTiming(transferStatus.tickTiming),
...
private fun safeStatusTickTiming(value: String): StatusTickTiming {
    return runCatching { StatusTickTiming.valueOf(value) }
